...
public class BpmMessageServiceImpl implements BpmMessageService {
    ...
    public void sendMessageWhenProcessInstanceApprove(BpmMessageSendWhenProcessInstanceApproveReqDTO reqDTO) {
        ...
        templateParams.put("content", reqDTO.getProcessInstanceName());
        templateParams.put("detailUrl", getProcessInstanceDetailUrl(reqDTO.getProcessInstanceId()));
//        smsSendApi.sendSingleSmsToAdmin(BpmMessageConvert.INSTANCE.convert(reqDTO.getStartUserId(),
//                BpmMessageEnum.PROCESS_INSTANCE_APPROVE.getSmsTemplateCode(), templateParams));
        notifySendService.sendSingleNotify(reqDTO.getStartUserId(), UserTypeEnum.ADMIN.getValue(),
                BpmMessageEnum.PROCESS_INSTANCE_APPROVE.getSmsTemplateCode(),templateParams );
    }
...
//                BpmMessageEnum.TASK_ASSIGNED.getSmsTemplateCode(), templateParams));
        ...
        notifySendService.sendSingleNotify(reqDTO.getAssigneeUserId(), UserTypeEnum.ADMIN.getValue(),
                BpmMessageEnum.TASK_ASSIGNED.getSmsTemplateCode(),templateParams );
    }
